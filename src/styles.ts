...
export const globalStyles = css`
	:host {
		...
		--dav-color-surface-bright-light-rgb: var(
			--dav-color-palette-neutral98-rgb
		);
		...
		--dav-color-surface-bright-dark-rgb: var(
			--dav-color-palette-neutral24-rgb
		);
		...
		--dav-color-surface-focus-dark-rgb: var(
			--dav-color-palette-neutral15-rgb
		);
		...
		--dav-color-surface-container: rgb(
			var(--dav-color-surface-container-rgb)
		);
